...
(def thumb-x (deg2rad 0))
(def thumb-y (deg2rad 0))
(def thumb-z (deg2rad 10))
...
(defn thumb-tr-place [shape]
  (->> shape
      ...
      ;  (rotate (deg2rad  -3) [0 0 1])
       (rotate thumb-x [1 0 0])
       (rotate thumb-y [0 1 0])
       (rotate thumb-z [0 0 1])
